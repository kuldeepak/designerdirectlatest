...
export async function action({ request }) {
  ...
  `, {
    ...
    const brandOrigin = formData.get("brand_origin");
    const priceRange = formData.get("price_range");
    const productionTime = formData.get("production_time");
    const minimumQuantity = formData.get("minimum_quantity");
    ...
    const ensureMetaobjectDefinition = async () => {
      ...
      const definition = {
        ...
        fieldDefinitions: [
          ...
          { name: "Price Range", key: "price_range", type: "single_line_text_field" },
          { name: "Production Time", key: "production_time", type: "single_line_text_field" },
          { name: "Minimum Quantity", key: "minimum_quantity", type: "single_line_text_field" },
    ...
    if (metaobjectId && metaobjectId.trim() !== "") {
      ...
      const fields = [
        ...
        { key: "phone", value: phone || "" },
        { key: "contact_email", value: email || "" },
        { key: "brand_origin", value: brandOrigin || "" },
        { key: "price_range", value: priceRange || "" },
        { key: "production_time", value: productionTime || "" },
        { key: "minimum_quantity", value: minimumQuantity || "" },
      ];
      if (lookbookFileId) fields.push({ key: "lookbook_file", value: lookbookFileId });
      if (linesheetFileId) fields.push({ key: "linesheet_pdf", value: linesheetFileId });
      ...
      const fields = [
        ...
        { key: "phone", value: phone || "" },
        { key: "contact_email", value: email || "" },
        { key: "brand_origin", value: brandOrigin || "" },        // ← ADD
        { key: "price_range", value: priceRange || "" },           // ← ADD
        { key: "production_time", value: productionTime || "" },   // ← ADD
        { key: "minimum_quantity", value: minimumQuantity || "" }, // ← ADD
      ];
      if (lookbookFileId) fields.push({ key: "lookbook_file", value: lookbookFileId });
      if (linesheetFileId) fields.push({ key: "linesheet_pdf", value: linesheetFileId });
